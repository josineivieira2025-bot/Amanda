const serviceEntries = [
  [
    'casamento',
    {
      ...
      seoKeywords: [
        'fotografo de casamento no rio de janeiro',
      ...
      imageAlt: 'fotografo de casamento no rio de janeiro registrando casal em dia de casamento',
      imageFileSuggestion: 'fotografo-casamento-rio-de-janeiro.jpg',
      bullets: [
  ...
  [
    'gestante',
    {
      ...
      imageAlt: 'ensaio gestante no rio de janeiro com fotografa registrando maternidade',
      imageFileSuggestion: 'ensaio-gestante-rj.jpg',
      bullets: [
  ...
  [
    'ensaio-infantil',
    {
      ...
      imageAlt: 'ensaio infantil rj com fotografa registrando crianca no rio de janeiro',
      imageFileSuggestion: 'ensaio-infantil-rj.jpg',
      bullets: [
  ...
  [
    'casal',
    {
      ...
      imageAlt: 'ensaio casal rj com fotografo registrando casal no rio de janeiro',
      imageFileSuggestion: 'ensaio-casal-rj.jpg',
      bullets: [
      ...
      relatedServices: [
        { slug: 'casamento', label: 'Fotografo de casamento RJ' },
        { slug: 'gestante', label: 'Ensaio gestante RJ' },
        { slug: 'ensaio-familia', label: 'Ensaio em familia' }
      ]
    }
  ...
  [
    'evento-infantil',
    {
      ...
      imageAlt: 'fotografa de festa infantil no rio de janeiro registrando aniversario',
      imageFileSuggestion: 'festa-infantil-rio-de-janeiro.jpg',
      bullets: [
...
export const serviceContent = Object.fromEntries(serviceEntries);

const aliasMap = serviceEntries.reduce((accumulator, [key, value]) => {
  value.aliases.forEach((alias) => {
    accumulator[alias] = key;
  });
  return accumulator;
}, {});
...
export const publicNavLinks = [
  { to: '/', label: 'Inicio' },
  { to: '/fotografo-casamento-rio-de-janeiro', label: 'Casamentos' },
...
export function resolveServiceKey(slug) {
  return aliasMap[slug] || slug;
}

export function getServiceContent(slug) {
  const key = resolveServiceKey(slug);
